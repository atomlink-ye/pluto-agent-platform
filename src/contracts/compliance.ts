...
const COMPLIANCE_STATUS_SET = new Set<string>(COMPLIANCE_STATUSES_V0);
const COMPLIANCE_ACTION_SET = new Set<string>(COMPLIANCE_ACTIONS_V0);
const COMPLIANCE_GOVERNED_OBJECT_KIND_SET = new Set<string>(COMPLIANCE_GOVERNED_OBJECT_KINDS_V0);
const REGULATED_PUBLISH_GATE_BLOCKED_REASON_SET = new Set<string>(REGULATED_PUBLISH_GATE_BLOCKED_REASONS_V0);
...
export function normalizeComplianceStatusV0(value: unknown): ComplianceStatusLikeV0 | null {
  ...
  if (COMPLIANCE_STATUS_SET.has(value)) {
    return value as ComplianceStatusV0;
  }
...
export function parseComplianceActionV0(value: unknown): ComplianceActionLikeV0 | null {
  ...
  if (COMPLIANCE_ACTION_SET.has(value)) {
    return value as ComplianceActionV0;
  }
...
export function parseComplianceGovernedObjectKindV0(value: unknown): ComplianceGovernedObjectKindLikeV0 | null {
  ...
  if (COMPLIANCE_GOVERNED_OBJECT_KIND_SET.has(value)) {
    return value as ComplianceGovernedObjectKindV0;
  }
...
export function toComplianceGovernedObjectRefV0(value: ComplianceGovernedObjectRefV0): ComplianceGovernedObjectRefV0 {
  switch (value.kind) {
    case "document":
...
export function validateComplianceActionEventRecordV0(
  value: unknown,
): GovernanceRecordValidationResult<ComplianceActionEventRecordV0> {
